...
>
> **⚠️ 警告**：当前版本为 **Alpha 版本**，**请勿在生产环境使用**。功能基本已移植完成，除 **即抽**、**URL功能**、**IPC功能** 外，其余功能均已可用。当前版本可能存在未知Bug，仅供用户体验。使用中如遇问题，欢迎前往 GitHub Issues 或 QQ 频道 反馈！
...
- 去除 **自定义抽功能**
- **开发计划**，重新梳理并明确后续开发方向：**即抽**、**URL功能**、**IPC功能** 等将逐步完善（当前版本尚未移植）
